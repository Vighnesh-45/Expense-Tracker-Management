...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(500, 650, 250, 50))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(1366, 800, 461, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(26)
        font.setBold(True)
    ...
    def tab(self):
        ...
        try:
            ...
            myc = mydb.cursor()
            qr = "select Date,Description,Amount,Type,Transaction_Method from Transaction where Account_No = '" + acc + "'"
            myc.execute(qr)
            result = myc.fetchall()
